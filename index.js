...
/**
 * Execution name must be a combination of one or more digits, letters a–z, underscores, and/or dashes,
 * satisfying the following regular expression: [0-9a-zA-Z\-\_]+
 * @type {String}
 */
Execution.prototype.name = null;
...
Execution.prototype._parseOptions = function (options) {
    options = _.omit(options, function(opt){
        return !_.isUndefined(opt.description) && _.isUndefined(opt.default)
    });
...
Execution.prototype._run = function(){
    var self = this;
    if(this.timeout){
